...
var viewProducts = function() {
    ...
    connection.query('SELECT * FROM Products', function(err, res) {
        console.log('');
        console.log(colors.white('Products for Sale'));
        console.log('');
...
var addInventory = function() {
    ...
    var addInvt = {
        properties: {
            inventoryID: {
                description: colors.red('What is the ID number of the product you want to add inventory for?')
            },
            inventoryAmount: {
                description: colors.cyan('How many items do you want to add to the inventory?')
            }
        },
    };
...
var addNewProduct = function() {
    ...
    var newProduct = {
        properties: {
            newIdNum: { description: colors.blue('Please enter a unique 5 digit item Id #') },
            ...
            newItemPrice: { description: colors.white('Please enter the price of the item in the format of 00.00') },
            newStockQuantity: { description: colors.red('Please enter a stock quantity for this item') },
        }
    }
